...
#define FN_ENT      LT(_FN, KC_ENT)              // Tap for Enter, holder for FN layer
...
[_QWERTY] = LAYOUT_planck_grid(
  ...
  BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   FN_ENT,  FN_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_planck_grid(
  ...
  _______, _______, _______, _______, _______, _______, _______, KC_UNDS, KC_EQL,  KC_LBRC, KC_RBRC, _______,
...
[_RAISE] = LAYOUT_planck_grid(
  ...
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_4,    KC_5,  KC_6,    KC_MINS, KC_BSLS,
...
[_FN] =  LAYOUT_planck_grid(
  ...
  _______, _______, _______, _______, _______, _______, KC_PGDOWN, _______, _______, _______,  _______, _______,
...
[_ADJUST] = LAYOUT_planck_grid(
  ...
  _______, _______, MU_MOD, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAKDH, _______, _______, _______,
