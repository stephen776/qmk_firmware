...
#define GUI_ESC     LGUI_T(KC_ESC)     // Tap for Esc, hold for Ctrl
#define SFT_ENT     LSFT_T(KC_ENTER)   // Tap for Enter, hold for Shift
#define FN_SPC      LT(_FN, KC_SPACE)  // Tap for Space, hold for FN layer
#define FN_ENT      LT(_FN, KC_ENTER)  // Tap for Space, hold for FN layer
...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   FN_SPC,  FN_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, _______, MU_MOD,  AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, COLEMAKDH, _______, _______, \
